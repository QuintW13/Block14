const inventory = [
  ...
  function getUppercaseNames(items) {
    // TODO: use `map`
    const eachInput = items.map((item)=>{return item.name.toUpperCase()
  ...
  function getItemById(items, id) {
    // TODO: use `find`
    const eachInput = items.find((item)=>{return item.id === id 
  ...
  function getItemsByCategory(items, category) {
    // TODO: use `filter`
    const eachInput = items.filter((item)=>{return item.category
